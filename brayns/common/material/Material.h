...
public:
    ...
    BRAYNS_API void setOpacityAttenuation(float value)
    {
        _opacityAttenuation = value;
    }
    BRAYNS_API float getOpacityAttenuation() const
    {
        return _opacityAttenuation;
    }
