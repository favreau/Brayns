...
public:
    ...
    Triangle(const VertexType& _p1, const VertexType& _p2,
    ...
    bool containsVertex(const VertexType& v) const
    {
        ...
        return almost_equal(p1, v) || almost_equal(p2, v) ||
               almost_equal(p3, v);
    }
...
inline bool almost_equal(const Triangle<T>& t1, const Triangle<T>& t2)
{
    return (almost_equal(t1.p1, t2.p1) || almost_equal(t1.p1, t2.p2) ||
           ...
           (almost_equal(t1.p3, t2.p1) || almost_equal(t1.p3, t2.p2) ||
            almost_equal(t1.p3, t2.p3));
}
} // namespace delaunay
#endif
