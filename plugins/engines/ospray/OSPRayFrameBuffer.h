...
public:
    OSPRayFrameBuffer(
        const Vector2ui& frameSize, FrameBufferFormat colorDepth,
        const AccumulationType accumulationType = AccumulationType::none);
    ~OSPRayFrameBuffer();
    ...
    size_t getFloatDepth() final { return 1; }
